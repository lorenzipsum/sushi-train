...
class MenuItemTest {
    ...
    void create_ok() {
        ...
        var salmonNigiri = MenuItem.create(SALMON_NIGIRI, PlateTier.GREEN, new YenAmount(450));
        ...
        assertAll("Asserting instantiated menu item",
                ...
                () -> assertEquals(YenAmount.of(450), salmonNigiri.getBasePrice()),
    ...
    void create_not_ok() {
        assertAll("Asserting correct behaviour instantiating with null values",
                () -> assertThrows(IllegalArgumentException.class, () -> MenuItem.create(null, PlateTier.GREEN, YenAmount.of(500))),
                () -> assertThrows(IllegalArgumentException.class, () -> MenuItem.create(SALMON_NIGIRI, null, YenAmount.of(500))),
                () -> assertThrows(IllegalArgumentException.class, () -> MenuItem.create(SALMON_NIGIRI, PlateTier.GREEN, null)),
                () -> assertThrows(IllegalArgumentException.class, () -> MenuItem.create("", PlateTier.GREEN, YenAmount.of(500))),
                () -> assertThrows(IllegalArgumentException.class, () -> MenuItem.create("   ", PlateTier.GREEN, YenAmount.of(500)))
        );
    }
    ...
    void create_trims_name() {
        var item = MenuItem.create("  Tuna  ", PlateTier.GREEN, YenAmount.of(300));
    ...
    void create_ids_unique() {
        var a = MenuItem.create("A", PlateTier.GREEN, YenAmount.of(100));
        var b = MenuItem.create("B", PlateTier.GREEN, YenAmount.of(100));
